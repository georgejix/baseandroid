package com.jx.pullrefreshview;
...
import com.jx.pullrefreshview.api.DefaultRefreshFooterCreator;
import com.jx.pullrefreshview.api.DefaultRefreshHeaderCreator;
import com.jx.pullrefreshview.api.RefreshContent;
import com.jx.pullrefreshview.api.RefreshFooter;
import com.jx.pullrefreshview.api.RefreshHeader;
import com.jx.pullrefreshview.api.RefreshInternal;
import com.jx.pullrefreshview.api.RefreshKernel;
import com.jx.pullrefreshview.api.RefreshLayout;
import com.jx.pullrefreshview.api.ScrollBoundaryDecider;
import com.jx.pullrefreshview.constant.DimensionStatus;
import com.jx.pullrefreshview.constant.RefreshState;
import com.jx.pullrefreshview.constant.SpinnerStyle;
import com.jx.pullrefreshview.footer.BallPulseFooter;
import com.jx.pullrefreshview.header.BezierRadarHeader;
import com.jx.pullrefreshview.impl.RefreshContentWrapper;
import com.jx.pullrefreshview.impl.RefreshFooterWrapper;
import com.jx.pullrefreshview.impl.RefreshHeaderWrapper;
import com.jx.pullrefreshview.listener.OnLoadMoreListener;
import com.jx.pullrefreshview.listener.OnMultiPurposeListener;
import com.jx.pullrefreshview.listener.OnRefreshListener;
import com.jx.pullrefreshview.listener.OnRefreshLoadMoreListener;
import com.jx.pullrefreshview.listener.OnStateChangedListener;
import com.jx.pullrefreshview.util.DelayedRunnable;
import com.jx.pullrefreshview.util.DensityUtil;
import com.jx.pullrefreshview.util.ScrollBoundaryUtil;
import com.jx.pullrefreshview.util.ViscousFluidInterpolator;
...
import static com.jx.pullrefreshview.util.DensityUtil.dp2px;
import static com.jx.pullrefreshview.util.SmartUtil.fling;
import static com.jx.pullrefreshview.util.SmartUtil.getColor;
import static com.jx.pullrefreshview.util.SmartUtil.isScrollableView;
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     * 设置多功能监听器
     *
     * @param listener 建议使用 {@link com.jx.pullrefreshview.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
     ...
     * 设置滚动边界
     *
     * @param boundary 建议使用 {@link com.jx.pullrefreshview.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
...
//    }
    ...
    public boolean refreshStatusNone()
    {
