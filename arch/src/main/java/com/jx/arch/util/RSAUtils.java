...
public class RSAUtils
{
    ...
    private static final String PUBLIC_KEY = "MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQCJZn2ECdwejJdoCN+VJ5ENtZDoXH47/W+9oWBFNLK9rgU2kH/O9ZgDjC8WudhX6xNYNlAU/0fOEodS7+3K9JSwTxid7PtsoK+bs6ue4omj5S3ny+lST5tXYqEu1Bk+j8KEg13/Xme+C7s4qZUHS1Q67Rq9a7zcJKaj/79UXdQxowIDAQAB";
    ...
    public static void getKeys() throws Exception
    {
        ...
        QMLog.i("RSA", "公钥" + publicKeyStr);
        QMLog.i("RSA", "私钥" + privateKeyStr);
    }
